      ...
      children: <Widget>[
        ...
        StatsColumn(
          stats: [
            ...
            Stat(name: Text(l10n.shieldTitle), value: Text('${avatar.shield}'), isVisible: true),
            Stat(name: Text(l10n.armorTitle), value: Text('${avatar.armor}'), isVisible: true),
            Stat(name: Text(l10n.healthTitle), value: Text('${avatar.health}'), isVisible: true),
            Stat(name: Text(l10n.powerTitle), value: Text('${avatar.power}'), isVisible: true),
            Stat(
