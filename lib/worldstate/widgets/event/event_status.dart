...
class EventStatus extends StatelessWidget {
  const new({super.key, required this.event});
  ...
  Widget build(BuildContext context) {
    ...
    final category = textTheme.titleMedium?.copyWith(color: ColorScheme.of(context).secondary);
    final tooltipStyle = textTheme.titleSmall?.copyWith(fontSize: 15);
...
class _EventTooltip extends StatelessWidget {
  const new({required this.tooltip});
...
class _EventProgress extends StatelessWidget {
  const new({this.scoreLocTag, this.health, this.currentScore, this.maxScore});
  ...
  Widget build(BuildContext context) {
    ...
    final tooltipStyle = TextTheme.of(context).titleSmall?.copyWith(fontSize: 15);
...
class _RewardTiles extends StatelessWidget {
  const new({required this.rewards});
...
class _RewardTile extends StatelessWidget {
  const new({required this.reward, required this.subRewards, required this.requiredScore});
  ...
  @override
  Widget build(BuildContext context) {
    final scoreStye = TextTheme.of(context).labelLarge;
