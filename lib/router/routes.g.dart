...
RouteBase get $deepArchimedeaPageRoute => GoRouteData.$route(
  path: '/deepArchimedea',
  name: 'deepArchimedea',
  factory: $DeepArchimedeaPageRouteExtension._fromState,
);

extension $DeepArchimedeaPageRouteExtension on DeepArchimedeaPageRoute {
  static DeepArchimedeaPageRoute _fromState(GoRouterState state) =>
      DeepArchimedeaPageRoute(state.extra as DeepArchimedea);

  String get location => GoRouteData.$location('/deepArchimedea');
