...
abstract class _$_InventoriaDatabase extends GeneratedDatabase {
  _$_InventoriaDatabase(QueryExecutor e) : super(e);
  $_InventoriaDatabaseManager get managers => $_InventoriaDatabaseManager(this);
...
class $$InventoryItemTableFilterComposer
    extends Composer<_$_InventoriaDatabase, $InventoryItemTable> {
...
class $$DriftProfileTableFilterComposer
    extends Composer<_$_InventoriaDatabase, $DriftProfileTable> {
...
class $_InventoriaDatabaseManager {
  final _$_InventoriaDatabase _db;
  $_InventoriaDatabaseManager(this._db);
