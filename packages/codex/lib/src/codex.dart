...
import 'package:warframestat_client/warframestat_client.dart' as wclient;
...
class Codex {
  ...
  Future<void> initializeCodex() async {
    final client = wclient.WarframeItemsClient(client: _client);
  ...
  Future<List<CodexItem>> syncXpInfo(List<XpItem> xpInfo) async {
    final conn = (dir: _database.instance.directory!, schemas: NavisDatabase.schemas, name: _database.instance.name);
